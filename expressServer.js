...
class ExpressServer {
    ...
    setupMiddleware() {
      ...
      this.app.get('/', (req, res) => res.sendFile(path.join(__dirname,'html','home.html')));
			...
			this.app.get('/workpackage', (req, res) => res.sendFile(path.join(__dirname,'html','workpackage.html')));
			this.app.get('/workpackage/:id', (req, res) => res.sendFile(path.join(__dirname,'html','workpackage.html')));
